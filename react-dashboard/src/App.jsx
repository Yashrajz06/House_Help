  ...
  const columns = [
    {
      ...
      cards: [
        ...
        { title: 'Service Category', subtitle: 'Service types (Maid, Plumber…)', link: 'http://localhost:3000/service_category.html' },
        ...
        { title: 'Area Master', subtitle: 'Areas within each city', link: 'http://localhost:3000/area_master.html' },
    ...
    },
    {
      ...
      cards: [
        ...
        { title: 'Reviews', subtitle: 'Customer ratings & feedback', link: 'http://localhost:5000/reviews.html' },
        { title: 'Provider Documents', subtitle: 'Uploaded ID & verification docs', link: null },
        { title: 'Complaints', subtitle: 'Issue tracking & resolution', link: 'http://localhost:5000/complaints.html' },
